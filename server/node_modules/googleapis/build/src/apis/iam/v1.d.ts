...
export declare namespace iam_v1 {
    ...
    export class Resource$Projects$Serviceaccounts$Keys {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Serviceaccounts$Keys$Patch, options: StreamMethodOptions): GaxiosPromise<Readable>;
        patch(params?: Params$Resource$Projects$Serviceaccounts$Keys$Patch, options?: MethodOptions): GaxiosPromise<Schema$ServiceAccountKey>;
        patch(params: Params$Resource$Projects$Serviceaccounts$Keys$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Serviceaccounts$Keys$Patch, options: MethodOptions | BodyResponseCallback<Schema$ServiceAccountKey>, callback: BodyResponseCallback<Schema$ServiceAccountKey>): void;
        patch(params: Params$Resource$Projects$Serviceaccounts$Keys$Patch, callback: BodyResponseCallback<Schema$ServiceAccountKey>): void;
    ...
    export interface Params$Resource$Projects$Serviceaccounts$Keys$Patch extends StandardParameters {
        /**
         * The resource name of the service account key in the following format `projects/{PROJECT_ID\}/serviceAccounts/{ACCOUNT\}/keys/{key\}`.
         */
        name?: string;
